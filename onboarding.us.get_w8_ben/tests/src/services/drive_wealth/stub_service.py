...
call_list_stub = (True, [{'documentID': '02e73c7d-fd38-44f0-acfe-d877de5e037d',
                          'type': {'name': 'TAX', 'description': 'Tax related documents'},
                          'receivedVia': 'TAX_GENERATOR_SYSTEM',
...
get_physical_invalid_stub = (False, {})
