...
@patch.object(EnumAdvisorCacheRepository, "save_enum_advisor")
@patch.object(EnumAdvisorCacheRepository, "get_enum_advisor")
def test_get_cached_enums_when_there_is_cache(
    ...
    result = AdvisorEnumRepository._get_advisor_cached_enum("")
    assert result == EnumAdvisorCacheRepository.get_enum_advisor()
...
def test_get_cached_enums_when_there_is_no_cache(
    ...
    assert EnumAdvisorCacheRepository.save_enum_advisor([])
